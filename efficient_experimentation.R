...
t.test(ATE$balanced,ATE$imbalanced) # iterations: 200, H0: diff in mean = 0 accepeted. Revalue if changes are made
t.test(ATE$balanced,ATE$individual) # iterations: 200, H0: diff in mean = 0 accepeted. Revalue if changes are made
t.test(ATE$individual,ATE$individual_dr) # iterations: 200, H0: diff in mean = 0 accepeted. Revalue if changes are made
